...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to 电能侠Agent. It handles general agent tasks such as web research, data analysis, and content generation, and can also coordinate energy dispatch, equipment operations, and control for solar-storage-charging stations.",
  ...
  knowledgeBase: {
    ...
    description:
      "Manage document catalogs, monitor indexing, and explore knowledge graphs and retrieval on the LightRAG data plane.",
    ...
    retry: "Retry",
    offlineTitle: "Knowledge base is offline",
    offlineDescription:
      "LightRAG is not available, so documents, the knowledge graph, and retrieval testing are paused. Contact your administrator to check the knowledge-base service.",
    ...
    graph: {
      ...
      showAll: "All",
      searchPlaceholder: "Search entities and locate…",
      noSearchResults: "No matching entities.",
      liveData: "Live data",
      loading: "Loading knowledge graph…",
      errorTitle: "Could not load the knowledge graph",
      empty: "The global graph has no data to display.",
      unavailable:
        "LightRAG must be ready and the Knowledge Scope enabled to browse the graph.",
      truncated:
        "The global graph reached the node limit; highly connected nodes are shown.",
      retry: "Retry",
      refresh: "Refresh graph",
      reset: "Reset",
      zoomIn: "Zoom in",
      zoomOut: "Zoom out",
      hint: "Scroll to zoom · drag the canvas to pan · click a node for details",
      degree: "Degree",
      relations: "Relations",
    ...
    retrieval: {
      modesTitle: "Retrieval mode",
      run: "Run retrieval",
      running: "Retrieving…",
      queryPlaceholder: "Enter a query…",
      resultTitle: "Retrieval evidence",
      sourcesTitle: "Text chunks",
      contextTitle: "Graph context",
      hitEntities: "Matched entities",
      hitRelations: "Matched relations",
      referencesTitle: "Referenced documents",
      keywordsTitle: "Retrieval keywords",
      highLevelKeywords: "Topic keywords",
      lowLevelKeywords: "Detail keywords",
      liveData: "Live data",
      unavailable:
        "LightRAG must be ready and the Knowledge Scope enabled to run retrieval.",
      errorTitle: "Retrieval failed",
      empty: "This query returned no evidence to display.",
      retry: "Retry",
      ...
      modeHints: {
        naive:
          "Naive vector search: recall chunks purely by semantic similarity, without the graph.",
        local:
          "Local search: focus on the direct neighbors of the query entities — best for specific, detailed questions.",
        global:
          "Global search: summarize themes and conclusions across documents from the relation network.",
        hybrid:
          "Hybrid search: combine local entities with global relations for both detail and overview.",
        mix: "Mix search: fuse graph recall and vector recall in parallel for the widest coverage.",
      },
    },
    status: {
    ...
    documents: {
      title: "Documents",
      description:
        "Upload source documents and follow their indexing status in LightRAG.",
      ...
      alreadyAccepted: "This upload was already accepted",
      uploadErrorTitle: "Document upload failed",
      featureDisabled: "Knowledge-base uploads are disabled by configuration.",
      scopeDisabled: "Enable the Knowledge Scope before uploading documents.",
      dataPlaneUnavailable:
        "LightRAG must be ready before uploading documents.",
      listTitle: "Document status",
      loading: "Loading documents…",
      listErrorTitle: "Documents are unavailable",
      retryList: "Retry",
      emptyTitle: "No documents yet",
      emptyDescription: "Choose a supported file above to start indexing.",
      trackingId: "LightRAG tracking ID",
      trackingPending: "Waiting to be assigned",
      ...
      manualRetry: "Retry",
      retrying: "Retrying…",
      retryErrorTitle: "Could not retry ingestion",
      deleteDocument: "Delete document",
      deletingDocument: "Deleting…",
      deleteDialogTitle: "Permanently delete this document?",
      deleteDialogDescription:
        "This will permanently remove the document from DeerFlow and LightRAG. This action cannot be undone.",
      deleteConfirm: "Delete permanently",
      deleteCancel: "Cancel",
      deleteErrorTitle: "Could not delete document",
      deleteErrorDescription:
        "An unknown error occurred while deleting the document.",
      retryWaitTitle: "The job will retry automatically",
      retryWaitDescription: "This page will keep refreshing; do not resubmit.",
      directoryTitle: "Directories",
      newDirectory: "New directory",
      createDirectory: "Create directory",
      createChildDirectory: "New subdirectory",
      renameDirectory: "Rename",
      deleteDirectory: "Delete directory",
      directoryName: "Directory name",
      directoryErrorTitle: "Directory action failed",
      uploadDestination: "Upload to",
      moveTo: "Move to",
      moving: "Moving…",
      managedSource: "Managed by DeerFlow",
      remoteSource: "LightRAG remote document",
      remoteNotice:
        "The original file is not managed by DeerFlow; only LightRAG metadata is synchronized.",
      contentLength: "Content length",
      noDocumentsInDirectory: "No documents in this directory.",
      breadcrumbRoot: "Root",
      refresh: "Refresh",
      pipelineTitle: "LightRAG indexing pipeline",
      diagnosticsTitle: "Ingestion diagnostics",
      pipeline: {
        upload: "Upload received",
        queue: "Queued",
        index: "LightRAG indexing",
        ready: "Index ready",
      },
      pipelineDetail: {
        uploaded: "The original file was stored",
        pending: "Waiting in the ingestion queue",
        queued: "The ingestion job was created",
        waiting: "Waiting for LightRAG processing",
        indexing: "Chunking, embedding and building the graph",
        indexed: "Chunking, embedding and graph processing completed",
        retrying: "Waiting to retry automatically",
        ready: "Available as a retrieval candidate",
        failed: "Ingestion failed",
      },
      progressStage: {
        pending: "Waiting for LightRAG",
        parsing: "Parsing document content",
        analyzing: "Analyzing multimodal content",
        preprocessed: "Content preprocessing completed",
        processing: "Extracting entities and relations, then writing the graph",
        processed: "LightRAG processing completed",
        failed: "LightRAG processing failed",
      },
      progressPhase: {
        contentParsing: "Content parsing",
        multimodal: "Multimodal analysis",
        entityExtraction: "Entity and relation extraction",
        graphWriting: "Graph writing",
      },
      stageElapsed: "Time in this stage",
      chunksCount: "chunks",
      status: {
