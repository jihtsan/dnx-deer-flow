...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用电能侠Agent。它不仅可以完成信息检索、数据分析和内容生成等智能体工作，\n还可以协助进行光储充场站的能源调度、设备协调与运行控制。",
  ...
  knowledgeBase: {
    title: "知识库",
    description:
      "基于 LightRAG 数据平面：管理文档目录、监控索引状态、探索知识图谱与检索。",
    loading: "正在检查知识库可用性…",
    requestErrorTitle: "无法获取知识库状态",
    requestErrorDescription:
      "DeerFlow 无法加载功能状态。导航入口会保持可见，以便问题不会被隐藏。",
    retry: "重试",
    offlineTitle: "知识库当前不在线",
    offlineDescription:
      "LightRAG 服务当前不可用，文档目录、知识图谱和检索测试已暂停。请联系管理员检查知识库服务状态。",
    checkAgain: "重新检查",
    ...
    scopeDescription: "描述",
    scopeDescriptionPlaceholder: "说明这个范围包含哪些知识",
    create: "创建 Knowledge Scope",
    creating: "正在创建…",
    createUnavailable: "LightRAG 数据平面就绪后才能创建。",
    save: "保存修改",
    saving: "正在保存…",
    saveSuccess: "修改已保存。",
    scopeStableId: "由服务端管理的唯一 Knowledge Scope",
    scopeEnabled: "已启用",
    scopeDisabled: "已禁用",
    enabledControl: "启用 Knowledge Scope",
    documentsTotal: "文档总数",
    documentsReady: "已就绪",
    documentsFailed: "失败",
    disabledRetrieval: "知识召回链路会将此范围识别为不可用。",
    enableUnavailable: "LightRAG 数据平面就绪后才能重新启用此范围。",
    ...
    graph: {
      ...
      popularGroups: "热门分组",
      showAll: "全部",
      searchPlaceholder: "搜索实体并定位…",
      noSearchResults: "没有匹配的实体。",
      liveData: "实时数据",
      loading: "正在加载知识图谱…",
      errorTitle: "无法加载知识图谱",
      empty: "全局图谱暂无可展示的数据。",
      unavailable: "LightRAG 就绪且 Knowledge Scope 启用后才能浏览图谱。",
      truncated: "全局图谱已达到节点上限，当前展示的是高关联节点。",
      retry: "重试",
      refresh: "刷新图谱",
      reset: "重置",
      zoomIn: "放大",
      zoomOut: "缩小",
      hint: "滚轮缩放 · 拖拽画布平移 · 点击节点查看详情",
      degree: "关联度",
      relations: "关系",
      source: "来源文档",
      close: "关闭",
    ...
    retrieval: {
      ...
      hitEntities: "命中实体",
      hitRelations: "命中关系",
      referencesTitle: "引用文档",
      keywordsTitle: "检索关键词",
      highLevelKeywords: "主题词",
      lowLevelKeywords: "细节词",
      liveData: "实时数据",
      unavailable: "LightRAG 就绪且 Knowledge Scope 启用后才能运行检索。",
      errorTitle: "检索失败",
      empty: "本次查询没有召回可展示的证据。",
      retry: "重试",
      entitiesCount: "实体",
      relationsCount: "关系",
      chunksCount: "分块",
      ...
      modeHints: {
        naive: "朴素向量检索：仅按语义相似度召回文本分块，不使用图谱。",
        local: "局部检索：聚焦查询实体的直接邻居，适合具体、细节性问题。",
        global: "全局检索：基于关系网络归纳跨文档的主题与总体结论。",
        hybrid: "混合检索：同时结合局部实体与全局关系，兼顾细节与概览。",
        mix: "融合检索：图谱召回与向量召回并行融合，覆盖面最广。",
      },
    },
    status: {
      unconfigured: "未配置",
    ...
    documents: {
      title: "文档",
      description: "上传原始文档，并持续查看 LightRAG 索引状态。",
      uploadTitle: "上传文档",
      fileLabel: "上传文档",
      selectedFile: "已选择",
      noFile: "尚未选择文件。",
      ...
      retryUpload: "重试上传",
      accepted: "文档已接收",
      alreadyAccepted: "该上传请求已接收",
      uploadErrorTitle: "文档上传失败",
      featureDisabled: "知识库上传功能已被配置禁用。",
      scopeDisabled: "请先启用 Knowledge Scope，再上传文档。",
      dataPlaneUnavailable: "LightRAG 就绪后才能上传文档。",
      listTitle: "文档状态",
      loading: "正在加载文档…",
      listErrorTitle: "无法获取文档列表",
      retryList: "重试",
      emptyTitle: "暂无文档",
      emptyDescription: "请在上方选择受支持的文件开始索引。",
      trackingId: "LightRAG tracking ID",
      trackingPending: "等待分配",
      ...
      manualRetry: "重试",
      retrying: "正在重试…",
      retryErrorTitle: "无法重试入库任务",
      deleteDocument: "删除文档",
      deletingDocument: "删除中…",
      deleteDialogTitle: "永久删除此文档？",
      deleteDialogDescription:
        "此操作会从 DeerFlow 和 LightRAG 中永久删除该文档，且无法撤销。",
      deleteConfirm: "永久删除",
      deleteCancel: "取消",
      deleteErrorTitle: "无法删除文档",
      deleteErrorDescription: "删除文档时发生未知错误。",
      retryWaitTitle: "任务将在稍后自动重试",
      retryWaitDescription: "页面会持续刷新，无需重复提交。",
      directoryTitle: "目录",
      newDirectory: "新建目录",
      createDirectory: "创建目录",
      createChildDirectory: "新建子目录",
      renameDirectory: "重命名",
      deleteDirectory: "删除目录",
      directoryName: "目录名称",
      directoryErrorTitle: "目录操作失败",
      uploadDestination: "上传到",
      moveTo: "移动到",
      moving: "正在移动…",
      managedSource: "DeerFlow 托管",
      remoteSource: "LightRAG 远端文档",
      remoteNotice: "原文件未由 DeerFlow 托管，当前仅同步 LightRAG 元数据。",
      contentLength: "内容长度",
      noDocumentsInDirectory: "当前目录暂无文档。",
      breadcrumbRoot: "根目录",
      refresh: "刷新",
      pipelineTitle: "LightRAG 索引流水线",
      diagnosticsTitle: "入库诊断",
      pipeline: {
        upload: "上传接收",
        queue: "进入队列",
        index: "LightRAG 索引",
      ...
      pipelineDetail: {
        ...
        pending: "正在入库队列中等待",
        queued: "入库任务已创建",
        waiting: "等待 LightRAG 处理",
        indexing: "正在分块、嵌入并构建图谱",
        indexed: "分块、嵌入与图谱处理完成",
        retrying: "等待自动重试",
        ready: "已成为可召回的检索候选",
        failed: "入库失败",
      },
      progressStage: {
        pending: "等待 LightRAG 接收",
        parsing: "正在解析文档内容",
        analyzing: "正在分析多模态内容",
        preprocessed: "内容预处理完成",
        processing: "正在抽取实体、关系并写入图谱",
        processed: "LightRAG 处理完成",
        failed: "LightRAG 处理失败",
      },
      progressPhase: {
        contentParsing: "内容解析",
        multimodal: "多模态分析",
        entityExtraction: "实体与关系抽取",
        graphWriting: "图谱写入",
      },
      stageElapsed: "本阶段已持续",
      chunksCount: "个分块",
