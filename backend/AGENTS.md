...
| **Features** (`/api/features`) | `GET /` - report `agents_api` availability plus the redacted five-state Knowledge Base / LightRAG status for frontend UI gating and diagnostics |
