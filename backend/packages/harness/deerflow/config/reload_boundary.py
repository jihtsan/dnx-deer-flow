...
STARTUP_ONLY_FIELDS: dict[str, str] = {
    ...
    "nexus_receiver": (
        "Receiver runtime, authentication, transport principals and recovery service are composed once during Gateway lifespan startup; all nexus_receiver.* changes require a restart and incomplete release dependencies remain default-deny."
    ),
    "run_ownership": (
